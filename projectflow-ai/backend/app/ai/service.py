...
from app.ai.models import AISession, AIMessage, AIProvider, AIModel
...
class AIService:
    ...
    # Chat functionality
    async def chat(self, session_id: str, user_message: str) -> schemas.ChatResponse:
        ...
        # Add user message
        user_msg = await self.add_message(session_id, schemas.AIMessageCreate(
            role="user",
    ...
    async def chat_stream(self, session_id: str, user_message: str) -> AsyncGenerator[schemas.StreamingChatChunk, None]:
    ...
    async def _generate_ai_response(self, session: AISession) -> dict:
        ...
        if session.provider == "openai":
            ...
            return {"content": "AI provider not implemented yet."}
    ...
    async def _generate_ai_response_stream(self, session: AISession) -> AsyncGenerator[str, None]:
        ...
        if session.provider == "openai":
            ...
            yield "AI provider not implemented yet."
